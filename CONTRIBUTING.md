...
### Linux Kernel
The KVM wrapper generation depends on the Linux kernel, so you need to have the
...
For this example we assume that you have both linux and kvm_wrapper
